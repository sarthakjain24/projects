...
/// <summary>
/// Testing for the Dependency Graph Tets
/// 
/// Author: Sarthak Jain
...
namespace DevelopmentTests
{
    ...
    public class DependencyGraphTest
    {
        ...
        /// <summary>
        /// Tests the getDependents method which should return an empty hashSet
        /// </summary>
        [TestMethod()]
        public void TestEmptyGetDependents()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b");
            t.AddDependency("a", "c");
            t.AddDependency("c", "b");
            t.AddDependency("b", "d");
            Assert.IsTrue(new HashSet<string>().SetEquals(t.GetDependents("d")));
        }

        /// <summary>
        /// Tests the getDependents method which should return the dependents 
        /// </summary>
        [TestMethod()]
        public void TestGetDependents()
        {
            ...
            list.Add("b");
            list.Add("c");
            Assert.IsTrue(list.SetEquals(t.GetDependents("a")));
        }

        /// <summary>
        /// Tests the getDependees method which should return an empty hashSet
        /// </summary>
        [TestMethod()]
        public void TestEmptyGetDependees()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b");
            t.AddDependency("a", "c");
            t.AddDependency("c", "b");
            t.AddDependency("b", "d");
            Assert.IsTrue(new HashSet<string>().SetEquals(t.GetDependees("a")));
        }

        /// <summary>
        /// Tests the getDependees method which should return the dependees 
        /// </summary>
        [TestMethod()]
        public void TestGetDependees()
        {
            ...
            list.Add("a");
            list.Add("c");
            Assert.IsTrue(list.SetEquals(t.GetDependees("b")));
        }

        /// <summary>
        /// Tests the this method with an empty dependency
        /// </summary>
        [TestMethod()]
        public void TestThisEmptyDependency()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b");
            t.AddDependency("a", "c");
        ...
        /// <summary>
        /// Tests the this method with a number of dependees expected
        /// </summary>
        [TestMethod()]
        ...
        /// <summary>
        /// Tests the hasDependents method which should return false
        /// </summary>
        [TestMethod()]
        ...
        /// <summary>
        /// Tests the hasDependents method which should return true 
        /// </summary>
        [TestMethod()]
        ...
        /// <summary>
        /// Tests the hasDependees method which should false
        /// </summary>
        [TestMethod()]
        ...
        /// <summary>
        /// Tests the hasDependees method which should return true 
        /// </summary>
        [TestMethod()]
        ...
        /// <summary>
        /// Tests the hasDependees method on an empty graph which should false
        /// </summary>
        [TestMethod()]
        public void TestEmptyGraphHasDependees()
        {
            DependencyGraph t = new DependencyGraph();
            Assert.IsFalse(t.HasDependees("a"));
        }
        ...
        /// <summary>
        /// Tests the hasDependents method on an empty graph which should false
        /// </summary>
        [TestMethod()]
        public void TestEmptyGraphHasDependents()
        {
            DependencyGraph t = new DependencyGraph();
        ...
        /// <summary>
        /// Tests the replaceDependents method 
        /// </summary>
        [TestMethod()]
        public void TestReplaceDependents()
        {
            ...
            t.AddDependency("c", "b");
            t.AddDependency("b", "d");
            t.ReplaceDependents("a", new HashSet<string>() { "f", "g", "e", "a" });
        ...
        /// </summary>
        [TestMethod()]
        public void TestReplaceDependentsWithoutCycle()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b");
            t.AddDependency("a", "c");
            t.AddDependency("c", "b");
            t.AddDependency("b", "d");
            t.ReplaceDependents("a", new HashSet<string>() { "f", "g", "e" });
        ...
        public void TestReplaceDependees()
        {
            ...
            t.AddDependency("c", "b");
            t.AddDependency("b", "d");
            t.ReplaceDependees("c", new HashSet<string>() { "f", "g", "e", "a" });
        ...
        /// </summary>
        [TestMethod()]
        public void TestReplaceDependeesWithoutCycle()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b");
            t.AddDependency("d", "c");
            t.AddDependency("c", "b");
            t.AddDependency("b", "d");
            t.ReplaceDependents("d", new HashSet<string>() { "f", "g", "e" });
            Assert.IsFalse(t.HasDependees("c"));
            Assert.IsFalse(t.HasDependees("a"));
        }
