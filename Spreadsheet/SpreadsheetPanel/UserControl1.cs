...
namespace SS
{
    ...
    public partial class SpreadsheetPanel : UserControl
    {
        ...
        //A private instance variable for darkMode
        ...
        private class DrawingPanel : Panel
        {
            ...
            {
                //If dark mode is false, then goes in here
                if (!darkMode)
                {
                ...
                //If dark mode is true, then goes in here
                else
                {
                    // Clip based on what needs to be refreshed.
                    Region clip = new Region(e.ClipRectangle);
                    ...
                    // Color the background of the data area black
                    e.Graphics.FillRectangle(
                    ...
                    // Pen, brush, and fonts to use
                    //Uses green to complement black as aesthetically pleasing background
                    ...
                    //Creates a new Brush with orange color
                    Brush orangeBrush = new SolidBrush(Color.Orange);

                    // Draw the text
                    //Sets the text in the spreadsheet to be orange
                    foreach (KeyValuePair<Address, String> address in _values)
                    {
                        String text = address.Value;
                        int x = address.Key.Col - _firstColumn;
