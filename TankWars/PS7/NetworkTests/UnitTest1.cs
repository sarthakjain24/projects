...
namespace NetworkUtil
{
    ...
    public class NetworkTests
    {
        ...
        [TestMethod]
        public void TestConnectTimeoutLessThan3()
        {
            bool isCalled = false;
            ...
            // The connection should timeout after 2 seconds. NetworkTestHelper.timeout is 5 seconds.
            NetworkTestHelper.WaitForOrTimeout(() => isCalled, 2000);
        ...
        [TestMethod]
        public void TestConnectToServerIPV6()
        {
            bool isCalled = false;
